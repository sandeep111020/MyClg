...
public class editnoteactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String employeeid = data.getStringExtra("name");
        ...
        msaveeditnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    firebasemodel addnewUser = new firebasemodel(newtitle,newcontent,employeeid);
                    reference.child("mynotes").setValue(addnewUser);


                    Toast.makeText(getApplicationContext(),"Task os Updated",Toast.LENGTH_SHORT).show();
                }
